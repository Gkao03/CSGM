...
def init_model(args):
    ...
    netG = models.DCGANGenerator(args.nz, args.ngf, args.nc).to(device)  # change this to use a different model
    ...
    netD = models.DCGANDiscriminator(args.ndf, args.nc).to(device)  # change this to use a different model
...
def train(args):
    ...
    # get the dataloader
    dataloader = utils.get_dataloader(args.image_dir, args.image_size, args.nc, args.batch_size)
